...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Qual pokémon deseja? "
				+ "\n[1] - Charmander"
				+ "\n[2] - Bulbasaur"
				+ "\n[3] - Squirtle");
		int escolha = scan.nextInt();
		if(escolha == 1) {
			System.out.println("Você está com Charmander.");
		System.out.println("Status do seu Pokémon atualizados:");
		System.out.println("Vida: "+charmander.vida);
			System.out.println("Você enfrentará Mewtwo! PREPARE-SE");
		...
		System.out.println("\nVida: "+charmander.vida);		
				...
				System.out.println("Você está com Bulbasaur.");
			}else if(escolha == 3) {
				System.out.println("Você está com Squirtle");
			}else {
