...
public class Program {
	...
	public static void main(String[] args) {
		...
		/*Usamos a classe abstrata e um método abstrato em implementação, pois assim conseguimos colocar todos os objetos em uma lista
		só assim usando o polimorfismo e deixando o código otimizado. Se a implementação dos métodos fosse feita em casa classe
		sem usar a classe genérica, não conseguiriamos colocar objetos diferentes na mesma lista.*/
